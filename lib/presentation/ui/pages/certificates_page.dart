...
import 'package:pr/presentation/ui/pages/json_detail_page.dart';
import 'package:pr/presentation/ui/theme/app_colors.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (_items.isEmpty) {
      return ListView(
        physics: const AlwaysScrollableScrollPhysics(),
        padding: const EdgeInsets.fromLTRB(16, 16, 16, 24),
        children: [_buildInfoBanner('Sertifikatlar topilmadi.')],
      );
    }
